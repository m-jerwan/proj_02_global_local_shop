...
public class Seeds {
    ...
    public static void seedData(){
        ...
        Product product_5 = new Product("Royal Cabbage", GroupType.VEGETEABLES, TagType.FAIRTRADE,0.4, farm_1, shop, 1.4);
        Product product_6 = new Product("Parsnip", GroupType.VEGETEABLES, TagType.ORGANIC,0.5, farm_2, shop, 1.0);
        Product product_7 = new Product("Honey", GroupType.MISC, TagType.VEGAN,0.5, farm_2, shop, 5.6);
        Product product_8 = new Product("Chickpeas", GroupType.PULSES, TagType.VEGAN,0.2, farm_3, shop, 0.50);
        Product product_9 = new Product("Sausages", GroupType.PROCESSED, TagType.ORGANIC,0.5, farm_2, shop, 8.0);
        Product product_10 = new Product("Rosemary", GroupType.HERBS, TagType.VEGAN,0.1, farm_2, shop, 3.0);
        ...
        Product product_17 = new Product("Angus Beef Mince", GroupType.MEAT, TagType.FAIRTRADE,0.6, farm_2, shop, 6.0);
        Product product_18 = new Product("Blueberries", GroupType.FRUITS, TagType.VEGETARIAN,.5, farm_2, shop, 4.0);
